              ...
              >
                <div
                  className={`transition-all ${
                    isUser
                      ? "max-w-[88%] sm:max-w-[80%] ml-auto px-3.5 py-2.5 bg-indigo-600 text-white rounded-2xl rounded-tr-xs shadow-xs text-xs sm:text-sm leading-relaxed font-medium"
                      : "w-full bg-white rounded-2xl border border-slate-200 shadow-xs p-3 sm:p-4 md:p-5"
                  }`}
                >
                  {isUser ? (
                      ...
                      <div className="flex items-center justify-between border-b border-slate-100 pb-2 mb-2.5 text-xs">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-medium text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-colors"
